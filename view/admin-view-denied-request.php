...
<div class="container-fluid">
    <div class="card w-100">
        <div class="card-body p-4">
            <h5 class="card-title fw-semibold mb-4">Denied Break Requests</h5>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td class='border-bottom-0'><span class='badge bg-danger rounded-3 fw-semibold'>" . ucfirst($row['status']) . "</span></td>";
                                echo "<td class='border-bottom-0'><h6 class='fw-semibold mb-0'>" . date('Y-m-d H:i:s', strtotime($row['created_at'])) . "</h6></td>";
                                echo "</tr>";
                                $counter++;
                            }
                        } else {
                            echo "<tr><td colspan='8' class='text-center'>No denied break requests found.</td></tr>";
                        }
